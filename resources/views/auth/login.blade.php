                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="checkbox">
                                    ...
                                    <label>
                                        <a class="login-qqbtn" href="qq" title="QQ登录"></a>
                                    </label>
                                    <label>
                                        <a class="login-weibobtn" href="weibo" title="新浪微博登录"><p>新浪微博登录</p></a>
                                    </label>
                                </div>
                            </div>
                        </div>
...
.login-qqbtn {
    width: 130px;
    height: 30px;
    background: url("{{ asset('images/broqiang/qq_login.gif') }}") no-repeat scroll 0 1px transparent;
    float: right;
}
.login-weibobtn
{
    ...
    width: 130px;
    height: 30px;
    background: url("{{ asset('images/broqiang/WB_logo5.png') }}") no-repeat scroll 0 1px transparent;
    float: right; 
}
.login-weibobtn p
{
